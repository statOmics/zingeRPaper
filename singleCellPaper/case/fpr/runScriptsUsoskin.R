...
runEdgeREMLibSize=function(e){
	...
	zeroWeights = zeroWeightsLibSizeDispFast(d, design, plot=FALSE, maxit=200, initialWeightAt0=TRUE, plotW=FALSE)
...
runDESeq2Zero <- function(e){
    ...
    zeroWeights = zeroWeightsLibSizeDispFast(counts(dse), design=model.matrix(~condition), colData=colData, plot=FALSE, maxit=200, initialWeightAt0=TRUE, plotW=FALSE, normalization="DESeq2_pos")
